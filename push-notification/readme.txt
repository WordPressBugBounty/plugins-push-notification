...
* Added: Segment users by the user role of the account they are logged into. #141
* Added: Show the subscription pop-up again by clicking a button on the page. #141
* Added: After logging into the portal, Visibility of subscription pop-up - only one that 1 page.#141
